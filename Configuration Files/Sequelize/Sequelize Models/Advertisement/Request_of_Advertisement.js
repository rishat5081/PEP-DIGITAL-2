...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Request_of_Advertisement.associate = (models) => {
    /**
    ...
    models.Managers.hasMany(Request_of_Advertisement, { foreignKey: "man_id" });
  ...
  // Managers.hasMany(Request_of_Advertisement, { foreignKey: "man_id" });

  // Request_of_Advertisement.belongsTo(Managers, {
  //   targetKey: "man_id",
  //   foreignKey: "man_id"
  // });
  ...
  return Request_of_Advertisement;
};
