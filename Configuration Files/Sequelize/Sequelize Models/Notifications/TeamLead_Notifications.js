...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  TeamLead_Notifications.associate = (models) => {
    /**
     * One Field Executive table will have many notifications
     */
    models.Team_Lead.hasMany(TeamLead_Notifications, {
      foreignKey: "team_L_id",
    });

    TeamLead_Notifications.belongsTo(models.Team_Lead, {
      targetKey: "team_L_id",
      foreignKey: "team_L_id",
    });
     ...
     * One Field Executive table will have many notifications
     */
    models.NotificationText.hasMany(TeamLead_Notifications, {
      foreignKey: "notification_id",
    });

    TeamLead_Notifications.belongsTo(models.NotificationText, {
