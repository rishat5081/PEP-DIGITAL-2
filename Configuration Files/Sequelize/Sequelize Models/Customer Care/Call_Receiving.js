...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Call_Receiving.associate = (models) => {
    /**
     * One CSR can make or recieve many calls
     */
    models.Customer_Care_Respresentative.hasMany(Call_Receiving, {
      foreignKey: "cust_care_id"
    });

    Call_Receiving.belongsTo(models.Customer_Care_Respresentative, {
  ...
  //  * One CSR can make or recieve many calls
  //  */
  // Customer_Care_Respresentative.hasMany(Call_Receiving, {
  //   foreignKey: "cust_care_id"
  // });
