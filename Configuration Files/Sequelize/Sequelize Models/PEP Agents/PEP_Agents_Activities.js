...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  PEP_Agents_Activities.associate = (models) => {
    models.PEP_Agents.hasMany(PEP_Agents_Activities, {
      foreignKey: "pep_dealers_id"
    });

    PEP_Agents_Activities.belongsTo(models.PEP_Agents, {
