...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  City_and_Supervisor_associate.associate = (models) => {
    /**City could have many supervisor  */
    models.City.belongsToMany(models.Supervisor, {
     ...
     */
    models.Supervisor.belongsToMany(models.City, {
      through: City_and_Supervisor_associate,
      foreignKey: "sup_id"
    });
  };
  ...
  // )
  return City_and_Supervisor_associate;
};
