...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Compaigns_Activities.associate = (models) => {
    /**
     * one compaign can have many activities
     */
    models.Compaigns.hasMany(Compaigns_Activities, {
      foreignKey: "comp_id"
    });

    Compaigns_Activities.belongsTo(models.Compaigns, {
      targetKey: "comp_id",
      foreignKey: "comp_id"
    });
     ...
     */
    models.Field_Executive.hasMany(Compaigns_Activities, {
      foreignKey: "field_id"
    });

    Compaigns_Activities.belongsTo(models.Field_Executive, {
      targetKey: "field_id",
      foreignKey: "field_id"
    });
     ...
     */
    models.Agency_Info.hasMany(Compaigns_Activities, {
      foreignKey: "agency_id"
    });

    Compaigns_Activities.belongsTo(models.Agency_Info, {
      targetKey: "agency_id",
      foreignKey: "agency_id"
    });
  };
