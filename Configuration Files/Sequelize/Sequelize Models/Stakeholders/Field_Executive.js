...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Field_Executive.associate = (models) => {
    /**
     * One login table will have only user
     */
    models.User_Login_Information.hasOne(Field_Executive, {
      foreignKey: "login_id"
    });

    Field_Executive.belongsTo(models.User_Login_Information, {
      targetKey: "login_id",
      foreignKey: "login_id"
    });
     ...
     */
    models.Team_Lead.hasMany(Field_Executive, {
      foreignKey: "team_L_id"
    });

    Field_Executive.belongsTo(models.Team_Lead, {
      targetKey: "team_L_id",
      foreignKey: "team_L_id"
    });
  };
