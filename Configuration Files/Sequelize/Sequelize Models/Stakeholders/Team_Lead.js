...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Team_Lead.associate = (models) => {
    /**
     * One user can have one login credential
     */
    models.User_Login_Information.hasOne(Team_Lead, {
      foreignKey: "login_id"
    });

    Team_Lead.belongsTo(models.User_Login_Information, {
      targetKey: "login_id",
      foreignKey: "login_id"
    });
     ...
     */
    models.City_Areas.hasMany(Team_Lead, {
      foreignKey: "city_area_id"
    });

    Team_Lead.belongsTo(models.City_Areas, {
     ...
     */
    models.Supervisor.hasMany(Team_Lead, {
      foreignKey: "sup_id"
    });

    Team_Lead.belongsTo(models.Supervisor, {
      targetKey: "sup_id",
      foreignKey: "sup_id"
    });
  };
