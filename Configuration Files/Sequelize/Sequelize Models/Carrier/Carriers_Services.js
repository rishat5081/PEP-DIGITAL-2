...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Carriers_Services.associate = (models) => {
    models.Carriers.hasMany(Carriers_Services, { foreignKey: "carrier_id" });

    Carriers_Services.belongsTo(models.Carriers, {
