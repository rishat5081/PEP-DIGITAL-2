...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Payment_Carrier_Services.associate = (models) => {
    /**One carrier have many payment  */

    models.Carriers.hasMany(Payment_Carrier_Services, {
      foreignKey: "carrier_id"
    });

    Payment_Carrier_Services.belongsTo(models.Carriers, {
  ...
  return Payment_Carrier_Services;
};
