...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Executive_Withdraws.associate = (models) => {
    /**
     * One field executive have many withdraws
     */

    models.Field_Executive.hasMany(Executive_Withdraws, {
      foreignKey: "field_id"
    });

    Executive_Withdraws.belongsTo(models.Field_Executive, {
      targetKey: "field_id",
      foreignKey: "field_id"
    });
    ...
    models.Executive_Pending_Earning.hasOne(Executive_Withdraws, {
      foreignKey: "field_exe_earn_id"
    });

    Executive_Withdraws.belongsTo(models.Executive_Pending_Earning, {
