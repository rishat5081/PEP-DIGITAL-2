...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Promotion_Request_Status.associate = (models) => {
    /**
     * One promotion can be start from request approved by Managers
     */
    models.Managers.hasMany(Promotion_Request_Status, { foreignKey: "man_id" });

    Promotion_Request_Status.belongsTo(models.Managers, {
      targetKey: "man_id",
      foreignKey: "man_id"
    });
    /**
     ...
     */
    models.Promotion_Req_By_Supervisor.hasMany(Promotion_Request_Status, {
      foreignKey: "prom_id"
    });

    Promotion_Request_Status.belongsTo(models.Promotion_Req_By_Supervisor, {
      targetKey: "prom_id",
      foreignKey: "prom_id"
    });
  };
