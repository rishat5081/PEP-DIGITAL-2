...
module.exports = (sequelize, { DataTypes, Model, UUIDV4 }) => {
  ...
  Promotion_Req_By_Supervisor.associate = (models) => {
    /**
     * One City can have many promotions
     */
    models.City.hasMany(Promotion_Req_By_Supervisor, { foreignKey: "city_id" });

    Promotion_Req_By_Supervisor.belongsTo(models.City, {
      targetKey: "city_id",
      foreignKey: "city_id"
    });
     ...
     */
    models.Supervisor.hasMany(Promotion_Req_By_Supervisor, {
      foreignKey: "sup_id"
    });

    Promotion_Req_By_Supervisor.belongsTo(models.Supervisor, {
      targetKey: "sup_id",
      foreignKey: "sup_id"
    });
  };
  ...
  return Promotion_Req_By_Supervisor;
};
