...
router.get(
  "/completedActivity/:activityUUID",
  isUser_Login,
  async (req, res) => {
    /**
...
router.get(
  "/progressAnalytics/:fieldExeUUID",
  isUser_Login,
  isUserAuthentic,
  async (req, res) => {
    /**
